...
Results-driven system administrator, software developer, and systems analyst with 21 years of military experience. Expertise in enterprise system integration, full-stack development, and database administration. Adept at administering Red Hat Enterprise Linux (RHEL) systems and OpenShift clusters, automating deployments with Ansible and shell scripting, and enforcing security compliance. Proven track record of optimizing performance, reducing manual workloads, and ensuring compliance in classified, mission-critical environments.

## TECHNICAL SKILLS

- **Certifications:** Red Hat Certified Engineer, Red Hat Certified System Administrator, CompTIA Security+
- **System Administration & Automation:** Red Hat Enterprise Linux (RHEL), SELinux, systemd, yum/dnf, RPM, Kickstart, OpenShift, Proxmox, Ansible, Bash, SSH, Git, VIM
- **Languages & Frameworks:** Python, Go, JavaScript, HTML, CSS, Bootstrap, React, SvelteKit, Astro
- **Database Systems:** MySQL, MongoDB, Firebase, PocketBase
- **Security & Compliance:** TS/SCI Clearance, Cyber Tasking Orders (CTO) patching, OSHA 10 Hour Maritime Industry Course

## PROFESSIONAL EXPERIENCE

### **Programmer Senior**

***General Dynamics Information Technology*** (2025-Present)

- Supported operation, maintenance, and troubleshooting of carry-on signals intelligence (SIGINT) systems aboard U.S. Navy vessels, performing the majority of tasks on RHEL and Red Hat–compatible Linux systems.
- Installed, configured, tested, and repaired servers, switches, Proxmox hypervisors, PXE-boot servers, workstations, and collection appliances.
- Automated provisioning and configuration using Ansible, PXE workflows, Kickstart, and shell scripting to build Proxmox and RHEL hosts.
- Applied security configurations and CTO-directed patching and vulnerability remediation to maintain compliance.
- Performed system integration and interoperability testing; validated end-to-end data flows across collection, processing, and workstation servers.
- Authored technical documentation and standard operating procedures, and executed release testing for new software versions.
- Collaborated with NSA, U.S. Navy personnel, government stakeholders, and contractors to resolve complex issues and prioritize capability enhancements.
