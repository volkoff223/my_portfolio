            ...
            <div class="z-10 sm:order-2 sm:col-span-6">
              <h3>
                <a
                  ...
                  href="https://www.freecodecamp.org/certification/volkoff223/scientific-computing-with-python-v7"
                  target="_blank"
                  rel="noreferrer noopener"
                  aria-label="Scientific computing with python certificate"
                  ><span
              ...
              <p class="mt-2 text-sm leading-normal">FreeCodeCamp.org</p>
            </div>
          </div>
        </li>
      </ul>
          ...
          >
            ...
            <div class="z-10 sm:order-2 sm:col-span-6">
              <h3>
                <a
                  class="inline-flex items-baseline font-medium leading-tight text-slate-200 hover:text-teal-300 focus-visible:text-teal-300 group/link text-base"
                  href="https://www.udemy.com/certificate/UC-9a0dd3b0-2fd7-4afc-96ae-8d0ccf30c0ea/"
                  target="_blank"
                  rel="noreferrer noopener"
                  aria-label="MERN stack from scratch"
                  ><span
                    class="absolute -inset-x-4 -inset-y-2.5 hidden rounded md:-inset-x-6 md:-inset-y-4 lg:block"
                  ></span><span
                    >MERN Stack from Scratch
              ...
              <p class="mt-2 text-sm leading-normal">Udemy.com</p>
            </div>
          </div>
        </li>
      </ul>
          ...
          >
            ...
            <div class="z-10 sm:order-2 sm:col-span-6">
              <h3>
                <a
                  class="inline-flex items-baseline font-medium leading-tight text-slate-200 hover:text-teal-300 focus-visible:text-teal-300 group/link text-base"
                  href="https://www.udemy.com/certificate/UC-49c33f5f-32b0-4343-ba53-bf8c78877c1a/"
                  target="_blank"
                  rel="noreferrer noopener"
                  aria-label="Web developer bootcamp certificate"
                  ><span
                    class="absolute -inset-x-4 -inset-y-2.5 hidden rounded md:-inset-x-6 md:-inset-y-4 lg:block"
                  ></span><span
                    >Web Developer Bootcamp
          ...
          >
            ...
            <div class="z-10 sm:order-2 sm:col-span-6">
              <h3>
                <a
                  class="inline-flex items-baseline font-medium leading-tight text-slate-200 hover:text-teal-300 focus-visible:text-teal-300 group/link text-base"
                  href="https://www.freecodecamp.org/certification/volkoff223/javascript-algorithms-and-data-structures"
                  target="_blank"
                  rel="noreferrer noopener"
                  aria-label="Javascript algorithms and data structurs certificate"
                  ><span
                    class="absolute -inset-x-4 -inset-y-2.5 hidden rounded md:-inset-x-6 md:-inset-y-4 lg:block"
                  ></span><span
                    >JavaScript Algorithms and Data Structures
          ...
          >
            ...
            <div class="z-10 sm:order-2 sm:col-span-6">
              <h3>
                <a
                  class="inline-flex items-baseline font-medium leading-tight text-slate-200 hover:text-teal-300 focus-visible:text-teal-300 group/link text-base"
                  href="https://www.freecodecamp.org/certification/volkoff223/responsive-web-design"
                  target="_blank"
                  rel="noreferrer noopener"
                  aria-label="Responsive web design certificate"
                  ><span
                    class="absolute -inset-x-4 -inset-y-2.5 hidden rounded md:-inset-x-6 md:-inset-y-4 lg:block"
                  ></span><span
                    >Responsive Web Design
