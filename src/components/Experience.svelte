				...
				>
					...
					<div class="z-10 sm:col-span-6">
						...
						<p class="mt-2 text-sm leading-normal">
							...
							clients including Harvard Business School, Everytown for Gun Safety, Pratt Institute,
							Koala Health, Vanderbilt University, The 19th News, and more. Provide leadership
			...
			<li class="mb-12">
				...
				>
					...
					<div class="z-10 sm:col-span-6">
						...
						<p class="mt-2 text-sm leading-normal">
							Developed and styled interactive web apps for Apple Music, including the UI of Apple
							Music’s embeddable web player widget for in-browser user authorization and full song
							playback.
						</p>
				...
				>
					...
					<div class="z-10 sm:col-span-6">
						...
						<p class="mt-2 text-sm leading-normal">
							...
							new brands, design systems, and websites for organizations in the community.
						</p>
						<ul class="mt-2 flex flex-wrap" aria-label="Technologies used">
							<li class="mr-1.5 mt-2">
								<div
