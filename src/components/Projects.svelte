				...
				>
					...
					<div class="z-10 sm:order-2 sm:col-span-6">
						...
						<p class="mt-2 text-sm leading-normal">
							...
							covered include the principles of REST APIs, user auth flows, Node, Express, React,
				...
				>
					...
					<div class="z-10 sm:order-2 sm:col-span-6">
						...
						<p class="mt-2 text-sm leading-normal">
							...
							recently played tracks, and detailed audio information about each track. Create and
							save new playlists of recommended tracks based on your existing playlists and more.
						</p>
						<a
