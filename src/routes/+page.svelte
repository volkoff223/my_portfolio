				...
				>
					...
					<div>
						<p class="mb-4">
							...
							head first into the rabbit hole of coding and web development. Fast-forward to today,
							and I’ve had the privilege of building software for an<!-- -->
							<a
							...
							<li class="mb-12">
								...
								>
									...
									<div class="z-10 sm:col-span-6">
										...
										<p class="mt-2 text-sm leading-normal">
											Collaborated with other student designers and engineers on pro-bono projects
											to create new brands, design systems, and websites for organizations in the
											community.
										</p>
										<ul class="mt-2 flex flex-wrap" aria-label="Technologies used">
											<li class="mr-1.5 mt-2">
								...
								>
									...
									<div class="z-10 sm:order-2 sm:col-span-6">
										...
										<a
											...
											target="_blank"
											rel="noreferrer noopener"
											aria-label="6874 stars on GitHub (opens in a new tab)"
											><svg
												xmlns="http://www.w3.org/2000/svg"
												viewBox="0 0 20 20"
												fill="currentColor"
				...
				<footer class="max-w-md pb-16 text-sm text-slate-500 sm:pb-0">
					<p>
						...
						<a
							...
							target="_blank"
							rel="noreferrer noopener"
							aria-label="Visual Studio Code (opens in a new tab)">Visual Studio Code</a
						>
						...
						<a
							...
							target="_blank"
							rel="noreferrer noopener"
							aria-label="Next.js (opens in a new tab)">Next.js</a
						>
						<!-- -->and<!-- -->
						<a
							...
							target="_blank"
							rel="noreferrer noopener"
							aria-label="Tailwind CSS (opens in a new tab)">Tailwind CSS</a
						>, deployed with<!-- -->
						<a
							...
							target="_blank"
							rel="noreferrer noopener"
							aria-label="Vercel (opens in a new tab)">Vercel</a
						...
						<a
							...
							target="_blank"
							rel="noreferrer noopener"
							aria-label="Inter (opens in a new tab)">Inter</a
						>
						<!-- -->typeface.
					</p>
				</footer>
